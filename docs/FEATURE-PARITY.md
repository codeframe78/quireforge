...
| Worktrees                              | Public desktop supports managed/permanent worktrees | Git CLI; Codex cwd                                                        | Inventory/create/attach complete; parallel use and cleanup remain            | M11A complete locally / 11B–11C planned       |
