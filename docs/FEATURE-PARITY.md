...
| Plans, commands, and diffs             | Desktop activity and diff views                     | Normalized app-server events plus Git CLI                                 | Bounded activity and read-only repository review state                       | M7/M9/M10A / complete locally                 |
| Git stage/revert/commit/push/PR        | Public desktop docs describe these controls         | Git CLI is authoritative                                                  | Read-only service complete; operation-specific mutation confirmation pending | M10A review complete / M10B mutations pending |
...
| File previews/notifications/editor     | Desktop integration                                 | OS/Tauri APIs                                                             | Revalidated changed-file handoff complete; broader preview/open-with remains | M10A partial / M15 broader work               |
